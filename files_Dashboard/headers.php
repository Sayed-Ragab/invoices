<?php include("../php_controller/notificationController.php");?>
										...
										<div class="main-notification-list Notification-scroll">
											...
											<a class="d-flex p-3 border-bottom" href="../invoices/invoicesDetalis.php?id=<?php echo $notification['id']?>">
												...
												<div class="mr-3">
													...
													<h5 class="notification-label mb-1"><?php echo $notification['message']?></h5>
									...
									<a class="profile-user d-flex" href=""><img alt="" src="../assets/img/faces/6.png"></a>
										...
										<div class="main-header-profile bg-primary p-3">
											<div class="d-flex wd-100p">
												<div class="main-img-user"><img alt="" src="../assets/img/faces/6.png" class=""></div>
												<div class="mr-3 my-auto">
													<h6><?php echo $_SESSION['name']??''?></h6><span><?php echo $_SESSION['EMAIL']??''?></span>
												</div>
											</div>
										</div>
										<a class="dropdown-item" href="../Dashboard/logout.php"><i class="bx bx-log-out"></i> تسجيل الخروج</a>
									</div>
								</div>
