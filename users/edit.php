                                ...
                                <form action="edit.php" method="POST" autocomplete="off">
                                    ...
                                    <?php foreach ($edits as $edit) { ?>
                                        <div class="">
                                            <div class="row mg-b-20">
                                                <div class="parsley-input col-md-6" id="fnWrapper">
                                                    ...
                                                    <input type="hidden" id="user_id" name="user_id" value="<?php echo $edit['id'] ?>">
                                                    <input class="form-control form-control-sm mg-b-20"
                                                        data-parsley-class-handler="#lnWrapper" name="name" required="" type="text" value="<?php echo $edit['name'] ?>">
                                                </div>

                                                <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                                    <label>البريد الالكتروني: <span class="tx-danger">*</span></label>
                                                    <input class="form-control form-control-sm mg-b-20"
                                                        data-parsley-class-handler="#lnWrapper" name="email" required="" type="email" value="<?php echo $edit['email'] ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row row-sm mg-b-30">
                                            <div class="col-lg-12">
                                                ...
                                                <select name="status" id="select-beast" class="form-control  nice-select  custom-select" name="status">
                                                    <option value="active" <?php echo ($edit['status'] == 'active') ? 'selected' : '' ?>>مفعل</option>
                                                    <option value="inactive" <?php echo ($edit['status'] == 'inactive') ? 'selected' : '' ?>>غير مفعل</option>
                                                </select>
                                            </div>
                                        </div>
                                                ...
                                                ?>
                                                    <div class="col-sm-4">
                                                        <div class="custom-control custom-checkbox">
                                                           ...
                                                           <?php echo in_array($module['id'], $userModules) ? 'checked' : ''; ?>>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                            <button  name="edit" class="btn btn-main-primary pd-x-20" type="submit">تاكيد</button>
                                        </div>
                                    <?php } ?>
                                </form>
